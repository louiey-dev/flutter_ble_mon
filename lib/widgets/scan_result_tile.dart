...
import 'package:flutter_ble_mon/screens/scan_screen.dart';
...
class _ScanResultTileState extends State<ScanResultTile> {
  ...
  Widget build(BuildContext context) {
    ...
    String advName = adv.advName.toLowerCase();
    String filterName = filterTextController.text.toLowerCase();

    if (advName.contains(filterName) == false) return Container();
